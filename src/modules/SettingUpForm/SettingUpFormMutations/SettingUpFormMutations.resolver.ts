...
} from '@modules/SettingUpForm/SettingUpFormMutations/SettingUpFormMutations.inputs';
import {
  CreateCategoryResponse,
  CreateQuestionResponse,
  CreateSectionResponse,
  CreateSubSectionResponse,
  SettingUpFormMutationsTypes,
} from '@modules/SettingUpForm/SettingUpFormMutations/SettingUpFormMutations.types';
